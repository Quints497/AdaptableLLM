...
class RagAssistant:
    ...
    def format_documents(self, query_results) -> str:
        """
    ...
    def query_vectorstore(self, query: str, k: int) -> list[Document]:
        """
    ...
    def rerank(self, query: str, query_results: list[Document], j: int) -> list[dict]:
        """
